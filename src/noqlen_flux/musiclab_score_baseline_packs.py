...
def build_scoring_good_candidates_pack() -> MusicLabScoreBaselinePack:
    baselines = [
        _baseline(
            ...
            expected_risk="low",
            expected_reason_codes=["artist-exact", "title-album-exact", "textual-exact"],
            forbidden_penalty_codes=["artist-mismatch", "title-album-mismatch", "low-declared-bitrate"],
            category="good",
        ...
        _baseline(
            ...
            expected_risk="low",
            expected_reason_codes=["artist-exact", "title-album-exact", "textual-exact"],
            forbidden_penalty_codes=["artist-mismatch", "title-album-mismatch"],
            category="good",
...
def build_scoring_provider_anomalies_pack() -> MusicLabScoreBaselinePack:
    baselines = [
        ...
        _baseline(
            ...
            expected_min_score=50.0,
            expected_penalty_codes=["low-declared-bitrate"],
            forbidden_penalty_codes=["provably-bad-file"],
            category="anomaly",
